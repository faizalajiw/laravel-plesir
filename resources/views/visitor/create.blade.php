    ...
    <div class="content container-fluid">
        <div class="page-header">
            <div class="row align-items-center">
                <div class="col">
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('list/categories') }}">Data Pengunjung</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('visitor/store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h5 class="form-title"><span>Tambah Data</span></h5>
                                </div>
                                ...
                                <div class="col-12 mt-4">
                                    <div class="d-flex gap-4">
                                        <div class="button-cancel">
                                            ...
                                            <a href="{{ route('list/visitor') }}" class="btn btn-danger">Batal</a>
                                            @endif
