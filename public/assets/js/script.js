(function ($) {
    ...
    if ($('.old-toggle-password').length > 0) { $(document).on('click', '.old-toggle-password', function () { $(this).toggleClass("feather-eye feather-eye-off"); var input = $(".pass-old"); if (input.attr("type") == "password") { input.attr("type", "text"); } else { input.attr("type", "password"); } }); }
